  ...
  return (
    <DashboardLayout allowedRoles={['admin']}>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-white">Admin/Staff Dashboard</h1>
        ...
        {/* Recent Transactions */}
        <div className="stat-card">
          <h3 className="font-semibold mb-4">Recent Transactions <span className="text-xs text-muted-foreground font-normal">(click to view receipt)</span></h3>
