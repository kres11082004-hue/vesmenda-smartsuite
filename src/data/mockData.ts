...
export const mockEmployees: Employee[] = [
  { id: 'EMP-001', name: 'Maria Santos', position: 'Store Manager', salary: 25000, startDate: '2023-01-15', status: 'Active', phone: '0917-123-4567' },
  { id: 'EMP-002', name: 'Juan Dela Cruz', position: 'Cashier', salary: 15000, startDate: '2023-06-01', status: 'Active', phone: '0918-234-5678' },
  { id: 'EMP-003', name: 'Ana Reyes', position: 'Stock Clerk', salary: 13000, startDate: '2024-02-10', status: 'Active', phone: '0919-345-6789' },
  { id: 'EMP-004', name: 'Pedro Garcia', position: 'Delivery', salary: 14000, startDate: '2024-05-20', status: 'On Leave', phone: '0920-456-7890' },
];
